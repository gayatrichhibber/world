...
ActiveRecord::Schema.define(version: 20160922062137) do
  ...
  create_table "admins", force: :cascade do |t|
    ...
    t.string   "present_id",     limit: 255
    t.string   "From_date",      limit: 255
    t.string   "todate",         limit: 255
    t.string   "number_of_days", limit: 255
    t.string   "leave",          limit: 255
    t.string   "leaveid",        limit: 255
    t.string   "total_salary",   limit: 255
  end
  ...
  create_table "models", force: :cascade do |t|
    ...
    t.string   "sponser_id",             limit: 255
    t.string   "ancestry",               limit: 255
    t.integer  "ancestry_depth",         limit: 4,   default: 0
  end

  add_index "models", ["ancestry"], name: "index_models_on_ancestry", using: :btree
